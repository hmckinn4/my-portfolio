...
const Home = () => {
  const [metaPrice, setMetaPrice] = useState(null);
  const [micronPrice, setMicronPrice] = useState(null);
    ...
    <div className="home-container">
      ...
      <div className="highlights-container">
        ...
        <div className="highlight">
          ...
          <p>
            <span className="important">Current Price: {metaPrice ? `$${metaPrice}` : 'Loading...'}</span>
        ...
        <div className="highlight">
          ...
          <p>
            <span className="important">Current Price: {micronPrice ? `$${micronPrice}` : 'Loading...'}</span>
