  ...
  return (
    <div className="projects-container">
      ...
      <div className="project-section">
        <h3 className="title">Financial Analyses</h3>
      ...
      <div className="project-section">
        <h3 className="title">Hockey Analyses</h3>
        <div className="project-links">
      ...
      <div className="project-section">
        <h3 className="title">Graduate School Software Applications</h3>
        <div className="project-links">
          ...
          <div className="project-subsection">
            <h4 className="title">Student Assignment Page Full Stack Remodel</h4>
      ...
      <div className="project-section">
        <h3 className="title">Software Applications</h3>
        <div className="project-links">
